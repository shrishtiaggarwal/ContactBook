...
<div class="container">
    ...
    <div class="panel" style="margin-top: 3%">
        <div style="background-color: #00415d" class="panel-heading">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form method="post" action="/">
                                ...
                                <input type="email" name="contactEmail" id="contactEmail" tabindex="2" class="form-control" placeholder="contactEmail" value="" required>
                                <input type="number" name="phoneNumber" id="phoneNumber" tabindex="3" class="form-control" placeholder="phoneNumber" value="" required>
                                ...
                                <c:forEach var="category" items="${categoryList}">
                                    <tr class="active">
                                        ...
                                        <td class="warning">
                                            ...
                                            <%--<span class="glyphicon glyphicon-trash"  style="font-size:10px;color:red" data-toggle="modal" data-target="#myModal5"></span>--%>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </table>
            ...
            <%--<form>--%>
                <%--&lt;%&ndash;<label for="search_input">Search:</label>&ndash;%&gt;--%>
                <%--<input type="text" id="search_input" placeholder="Search" style="float: right">--%>
            <%--</form>--%>
            <%--<input style="float: right" type="text" placeholder="Search" name="search">--%>
        </div>
    </div>
    <form action="/userSearch"></form>
    <input type="text" name="freeText" id="search2" placeholder="search ContactName">
    <button id="search1" onclick="searchUserContacts()">find</button>
...
<div id="contactList">
             <c:forEach var="contact" items="${contactList}">
                  <tr class="active">
                      ...
                      <td class="warning">
                          <span class="glyphicon glyphicon-pencil" style="font-size: 20px;color: #1CA347" data-toggle="modal" data-target="#myModal3" data-toggle="tooltip" onclick="getContactInfo(${contact.contactId})"></span>
                          <span class="glyphicon glyphicon-trash"  style="font-size:20px;color:red" data-toggle="tooltip" data-placement="top" title="Click to delete the Contact" onclick="deletecontact(${contact.contactId}) "></span>
                          <%--<span class="glyphicon glyphicon-trash"  style="font-size:20px;color:red"  data-toggle="modal" data-target="#myModal4"></span>--%>
                      </td>
                   </tr>
</div>
                         ...
                         <div class="modal-content">
                             ...
                             <div class="modal-body">
                                 ...
                                 <form>
                                     ...
                                     <input type="email" name="contactEmail" id="contactEmailUpdate" tabindex="2" class="form-control" placeholder="contactEmail" value="" required>
                                     <input type="number" name="phoneNumber" id="phoneNumberUpdate" tabindex="3" class="form-control" placeholder="phoneNumber" value="" required>
                                     ...
                                     <input type="hidden" name="contactId" id="contactIdUpdate" tabindex="5" required>
                                     <%--<select id="categoryUpdate" multiple>--%>
                                     <%--<c:forEach var="catList" items="${category}">--%>
                                         <%--<option  value="${catList.categoryId}">${catList.categoryName}</option>--%>
                                     <%--</c:forEach>--%>
                                     <%--</select>--%>
    ...
    function getContactInfo(id) {
        ...
        jQuery.ajax({
            ...
            success:function (data) {
              ...
              //  jQuery("#categoryUpdate").multiselect('select',data.categoryName);
                jQuery("#contactIdUpdate").val(data.contactId);
...
// $("#contactList").html('');
    $.ajax({
        url: "/searchContact?freeText=" +$("#search2").val(),
        type: "GET",
        success: function (data) {
            $.each(data, function (key, val) {
                $("#contactList").append("<tr><td>" + data[key].contactName + "</td><td>" + data[key].contactEmail + "</td><td>" + data[key].phoneNumber + "</td>" + "<td>" + data[key].companyName + "</td>" + "<td>" + data[key].category[0].categoryName + "</td>></></td></tr>");
            });
        }
    });
}
    ...
    function updateContact(id) {
        ...
        var category=jQuery.trim(jQuery("#categoryUpdate").val());
        var contactId = jQuery.trim(jQuery("#contactIdUpdate").val());
        jQuery.ajax({
            url:"/updateContact",
            type:"POST",
            data:{contactId:contactId,contactName:contactName,contactEmail:contactEmail,phoneNumber:phoneNumber,companyName:companyName,categoryName:category},
            success:function (data) {
