                ...
                <div class="panel-body">
                    <div class="row">${msg}${logoutmsg}
                        <div class="col-lg-12">
                            ...
                            <form id="register-form" action="/registerationDone" method="post" role="form" style="display: none;">
                                <div class="form-group">
                                    <input type="text" name="userName" id="username" tabindex="1" class="form-control" placeholder="Username" value="" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <%--<td><form:errors path="user.confirmPassword" cssClass="error" /></td>--%>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-sm-6 col-sm-offset-3">
